...
### 3.2 GitHub Actions CI Run

**Placeholder**: `[Screenshot: GitHub Actions workflow run showing successful CI pipeline execution]`

**Description**: GitHub Actions workflow run showing:
...
**Location**: GitHub repository → Actions tab → CI Pipeline workflow

---

### 3.3 GitHub Actions CD Deployment

**Placeholder**: `[Screenshot: GitHub Actions CD workflow showing successful deployment to Azure]`

**Description**: CD pipeline execution showing:
- Docker image build
- ACR login and push
- Azure Web App deployment
- Successful deployment confirmation

**Location**: GitHub repository → Actions tab → CD Pipeline workflow

---

### 3.4 `/metrics` Output in Swagger

**Placeholder**: `[Screenshot: Swagger UI showing /metrics endpoint with sample response]`

**Description**: Swagger UI (`/docs`) showing:
- `/metrics` endpoint documentation
- Example response with all four metrics fields
- Try it out functionality
- Response showing actual metrics values

**Location**: `http://localhost:8000/docs` (local) or Azure Web App URL + `/docs`

---

### 3.5 Docker Image Build Locally

**Placeholder**: `[Screenshot: Terminal showing successful Docker build command and output]`

**Description**: Terminal output showing:
- `docker build -t emerald-ledger:latest .` command
- Docker build steps execution
- Successful build completion
- Image size and layer information

**Location**: Local terminal after running `docker build`

---

### 3.6 Azure Web App Deployment Logs (Optional)

**Placeholder**: `[Screenshot: Azure Portal showing Web App deployment logs and container status]`

**Description**: Azure Portal showing:
- Container deployment status
- Application logs
- Health check status
- Metrics and monitoring data

**Location**: Azure Portal → Web App → Deployment Center / Logs
